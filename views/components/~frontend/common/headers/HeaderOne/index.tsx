          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-md-6">
              <div className="mh-content text-center text-md-left">
                ...
                <a className="mh-content__subtitle" href="/hiring">
                  Are you driven and looking for a opportunity?
                </a>
              </div>
            </div>
            <div className="col-md-6">
              <ul className="mh-content-2 justify-content-center justify-content-md-end">
                <li>
                  <a href="tel:+923080496028" className="mh-tel">
                    <span className="gl-icon u-s-mr-2">
                      <FaPhone />
                    </span>
                ...
                <li>
                  ...
                  >
                    ...
                    <span>ahmadhussnain787@gmail.com</span>
                  </a>
                </li>
              </ul>
            </div>
      ...
      <header className="header-d" id="header-d">
          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-xl-5 col-lg-7 col-md-7 d-md-block d-none">
                <GoInput
                  input={{ placeholder: 'Go to Section', id: 'g-input' }}
              ...
              <div className="col-xl-4 col-lg-2 col-md-2 col-6">
                ...
                <nav className="menu">
                  ...
                  <div className="menu-wrap">
                    <button
                      type="button"
                      className="btn--icon menu__btn-0"
                    ...
                    <button
                      type="button"
                      className="btn--icon menu__btn-1"
        ...
        {partB && (
          <div className="part-b">
            <GoInput
              input={{ placeholder: 'Go to Section', id: 'g-input-2' }}
            />
            <button
              type="button"
              className="btn--icon gl-icon part-b__btn"
              onClick={handlePartBClick}
            >
              <MdClose />
            </button>
